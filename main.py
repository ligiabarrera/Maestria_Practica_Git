from datapreputils import remove_null, fill_missing, std_dev, mean, get_mode, get_harmonic_mean, get_geometric_mean, min_max, z_score


data_array = [10, None, 20, float('nan'), 30, 10, 20 ,30, 40, 50]

print("Array de datos:", data_array)
